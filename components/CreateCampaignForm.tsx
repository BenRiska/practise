...
const CreateCampaignForm = ({createCampaign, campaignState, setCampaignState}: any) => {
  ...
  return <div className='my-12'>
    ...
    {campaignState.type === "MAIL" && <div className="border-red-200 hover:border-red-400 mt-8 border-2 rounded p-8 flex flex-col items-center">
      <h2 className="flex">
        <p className="border-red-400 flex align-center rounded-full border-2 h-8 w-8 mr-4">
    ...
    <div className="border-red-200 hover:border-red-400 mt-8 border-2 rounded p-8 flex flex-col items-center">
      <h2 className="flex">
        <p className="border-red-400 flex align-center rounded-full border-2 h-8 w-8 mr-4">
          <span className="w-full flex items-center justify-center">{campaignState.type === "LEMLIST" ? 3 : 4}</span>
        </p> 
    ...
    <div className="border-red-200 hover:border-red-400 mt-8 border-2 rounded p-8 flex flex-col items-center">
      <h2 className="flex">
        <p className="border-red-400 flex align-center rounded-full border-2 h-8 w-8 mr-4">
          <span className="w-full flex items-center justify-center">{campaignState.type === "LEMLIST" ? 4 : 5}</span>
        </p> 
    ...
    <div className="border-red-200 hover:border-red-400 mt-8 border-2 rounded p-8 flex flex-col items-center">
      <h2 className="flex">
        <p className="border-red-400 flex align-center rounded-full border-2 h-8 w-8 mr-4">
          <span className="w-full flex items-center justify-center">{campaignState.type === "LEMLIST" ? 5 : 6}</span>
        </p> 

...
const Sidebar = ({ menuOpen, setMenuOpen, logout }: any) => {
  ...
  return <motion.div style={{ borderRight: "2px solid rgba(243, 244, 246, 1)" }} ref={ref} initial={{ left: -288 }} animate={{ left: menuOpen ? 0 : -288 }} className="h-screen flex flex-col w-72 top-0 fixed z-50 bg-white">

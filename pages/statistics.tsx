...
import EmberGradeBreakdown from '../components/charts/EmberGradeBreakdown';
import CompanyFormationBreakdown from '../components/charts/CompanyFormationBreakdown';
import EmberSICBreakdown from '../components/charts/EmberSICBreakdown';
import CampaignSizeBreakdown from '../components/charts/CampaignSizeBreakdown';
import CampaignCostBreakdown from '../components/charts/CampaignCostBreakdown';
import TopPerformingCampaigns from '../components/charts/TopPerformingCampaigns';
import AverageDirectorAge from '../components/charts/AverageDirectorAge';
import DirectorOwnedCompanyCount from '../components/charts/DirectorOwnedCompanyCount';
import TopDirectorLocation from '../components/charts/TopDirectorLocation';
import MostPopularName from '../components/charts/MostPopularName';
import SSGMPerformanceChart from '../components/charts/SSGMPerformanceChart';
...
const Home: NextPage = () => {
  ...
  return (
    <div className='max-w-7xl mx-auto relative' style={{ minHeight: "100vh" }}>
      ...
      <AnimatePresence>
        {modalIsOpen && <motion.div initial={{ height: 750, width: 1300 }} animate={{ height: modalIsOpen ? 750 : 0, width: modalIsOpen ? 1300 : 0 }} className='absolute shadow-md mx-auto top-0 left-0 right-0 w-full b-0 h-full bg-white'>
          {getCurrentStatisticComponent(currentStatistic)}
          <div style={{ left: 20, bottom: 20 }} onClick={closeModal} className='absolute cursor-pointer'><CloseIcon /></div>
        </motion.div>
        }
      </AnimatePresence>
